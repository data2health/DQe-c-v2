...
with open("/Users/mehadi/work/d2health/DQe-c-v2/configs/config.json") as json_file:
...
dato <- read.csv("/Users/mehadi/work/d2health/DQe-c-v2/mhTest/realTables/tablelist.csv")
...
DQTBL: object = pd.read_csv("/Users/mehadi/work/d2health/DQe-c-v2/mhTest/realTables/DQe-c_report.csv")
...
if (CDM %in% c("PCORNET3","PCORNET31","OMOPV5_0","OMOPV5_2","OMOPV5_3")) {
...
```{r, echo=FALSE}
#DQTBL <- dato
DQTBL <- read.csv("/Users/mehadi/work/d2health/DQe-c-v2/mhTest/realTables/DQe-c_report.csv")
...
ggplot(comp, aes(x=reorder(TEST_DATE,TEST_DATE), y=UNIQUE_FREQ, group = ColNam) ) + 
...
plot2 <- ggplot(data=patid, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
...
(gg <- ggplotly(plot2))
 ...
 plot2 <- ggplot(data=person_id, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
   geom_bar(stat="identity", width = 1, )+#aes(fill=Index)) +
   scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
plot3 <- ggplot(data=encounterid, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
  geom_bar(stat="identity", width = 1,)+# aes(fill=Index)) +
  scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
(gg <- ggplotly(plot3))
 ...
 plot3 <- ggplot(data=care_site_id, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
   geom_bar(stat="identity", width = 1,)+# aes(fill=Index)) +
   scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
plot4 <- ggplot(data=providerid, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
  geom_bar(stat="identity", width = 1, )+#aes(fill=Index)) +
  scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
(gg <- ggplotly(plot4))
 ...
 plot4 <- ggplot(data=visit_occurrence_id, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
   geom_bar(stat="identity", width = 1, )+#aes(fill=Index)) +
   scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
plot5 <- ggplot(data=enc_type, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
  geom_bar(stat="identity", width = 1, )+#aes(fill=Index)) +
  scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
(gg <- ggplotly(plot5))
 ...
 plot5 <- ggplot(data=location_id, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
   geom_bar(stat="identity", width = 1, )+#aes(fill=Index)) +
   scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
plot6 <- ggplot(data=prescribingid, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
  geom_bar(stat="identity", width = 1, )+#aes(fill=Index)) +
  scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
(gg <- ggplotly(plot6))
 ...
 plot6 <- ggplot(data=visit_detail_id, aes(x=reorder(TabNam, UNIQUE_FREQ), y=UNIQUE_FREQ)) +
   geom_bar(stat="identity", width = 1, )+#aes(fill=Index)) +
   scale_fill_manual(values=c("darkolivegreen3","firebrick1", "springgreen3")) +
...
withouts <- read.csv("/Users/mehadi/work/d2health/DQe-c-v2/mhTest/realTables/indicators_report.csv")
